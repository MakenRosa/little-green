        ...
        <CardGroup className={styles.cardGroup}>
          <Card className={styles.card}>
            <Card.Body>
              ...
              <Card.Text className={styles.cardText}>
                ...
                preparando nossos alunos para se tornarem líderes responsáveis e
          ...
          <Card className={styles.card}>
            <Card.Body>
              ...
              <Card.Text className={styles.cardText}>
                Buscamos ser uma referência em práticas educacionais que
                integram os princípios de ESG. Queremos ser reconhecidos como
                uma instituição que forma profissionais capacitados e
                conscientes de seu papel na construção de um mundo mais justo,
